...
public class EmployeeControllerIntTest {
	...
	private static final Logger log = LoggerFactory.getLogger(EmployeeControllerIntTest.class);

    public EmployeeControllerIntTest() {}
    ...
    public void testGetEmployeesJson() {
        ...
        log.debug("Before getEmployeesJson()");
      //test the add functionality
        Assert.assertEquals(employeeController.getEmployeesJson(), employees);
        log.debug("After getEmployeesJson()");
